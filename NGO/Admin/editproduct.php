<?php
 ...
 $sql =$mysqli->query("SELECT * FROM user_table WHERE user_id ='$id'");
 $row = $sql->fetch_assoc();
 ?>
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="pid" name="uid" value="<?=$row['user_id']?>"
        readonly>
    </div>
    <div class="form-group">
...
<?php
 if(isset($_POST['update']))
 {
    ...
    $sqle =$mysqli->query("UPDATE user_table SET username = '$uname', email = '$uemail', verified = '$verified' WHERE user_id = '$id'");
    if($sqle == TRUE){
