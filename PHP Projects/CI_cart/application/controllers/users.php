...
class users extends CI_Controller
{
    ...
    function login_view(){
        ...
        if($this -> session -> has_userdata('id')){//checking if we are in the dashboard page,and if the session exists then we will be redirect to the same page and back button won't work
