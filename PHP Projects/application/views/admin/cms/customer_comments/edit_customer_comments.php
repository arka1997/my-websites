                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="forms-sample-add_menu" method="post"  action="<?php echo base_url();?>admin/customer_comments/update_customer_comments/<?=$comments->id?>" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="testimonial_details">Testimonial Details</label>
                                            <input type="text" class="form-control" id="testimonial_details" name="testimonial_details"  value="<?=$comments->testimonial_details?>">
                                            <span class="text-danger"><?php echo form_error('testimonial_details'); ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="customer_name">Customer Name</label>
                                            <input type="text" class="form-control" id="customer_name" name="customer_name" value="<?=$comments->customer_name?>">
                                            <span class="text-danger"><?php echo form_error('customer_name'); ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="position">Position(currently doing what)</label>
                                            <input type="text" class="form-control" id="position" name="position" value="<?=$comments->position?>">
                                            <span class="text-danger"><?php echo form_error('position'); ?></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="company">Company</label>
                                            <input type="text" class="form-control" id="company" name="company" value="<?=$comments->company?>" >
