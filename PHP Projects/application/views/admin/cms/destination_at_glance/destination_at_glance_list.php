                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Why choose us <button class="btn btn-sm btn-outline-info" data-toggle="modal" data-target="#modal-default" >Add Details</button>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($destination_at_glance as $key => $w) { ?>
                                        <tr>
                                            <td><?=++$key?></td>
                                            <td><?= $w->title ?></td>
                                            <td style="text-align: center;">
                                                ...
                                                <a href="javascript:void(0)" onclick="return delete_modal('<?php echo base_url('admin/destination_at_glance/delete_destination_at_glance/'); ?><?= $w->id ?>')" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="forms-sample-add_menu" method="post" action="<?php echo base_url(); ?>admin/destination_at_glance/insert_destination_at_glance" enctype="multipart/form-data">
...
<!-- /.content-wrapper -->
<!--EDIT Model -->
<?php if ($destination_at_glance) {
    foreach ($destination_at_glance as $key => $w) { ?>
        <div class="modal fade" id="modal-default<?php echo $w->id; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="forms-sample-add_menu" method="post" action="<?php echo base_url(); ?>admin/destination_at_glance/update_destination_at_glance/<?= $w->id ?>" enctype="multipart/form-data">
                        <div class="modal-header">
                                        ...
                                        <div class="container ">
                                            <div class="card-group row col-md-12 ">
                                                    <div class="card col-md-4">
                                                        <img src="<?php echo base_url('uploads/destination_at_glance/' . $w->main_image); ?>" width="100" height="100"></label>
                                                    </div>
                                            </div>
                                        </div>
                                        <!-- //Image preview -->
