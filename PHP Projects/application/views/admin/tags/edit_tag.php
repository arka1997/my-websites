        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                  ...
                  <!-- form start -->
                  <form id="tags" class="forms-sample-add_menu" method="post"  action="<?php echo base_url();?>admin/tags/update_tags/<?=$param->id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="row">
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputtags" name="tags" value="<?=$param->tag_name?>">
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="status[]">
                                <option value="1" <?php if($param->status==1){ echo "selected"; }?> >Active</option>
                                <option value="0" <?php if($param->status==0){ echo "selected"; }?> >Deactive</option>
                            </div>
                          </div>
                           <div class="col-md-2">
                            <div class="form-group">
