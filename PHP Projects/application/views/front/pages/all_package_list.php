    ...
    <div class="inner">
        ...
        <div class="one pp_tour_search">
            <div class="page_content_wrapper"> -->
                ...
                <form id="tour_search_form" method="post" action="<?php echo base_url(); ?>front/cms/load_variation_packages" enctype="multipart/form-data">
                ...
                <h2 class="ppb_title ">All Packages & Offers</h2>
                        ...
                        <div class="one_third gallery3 filterable gallery_type animated<?=$key?>" data-id="post-<?=$key?>">
                            ...
                            <div class="thumb_content classic">
                                <div class="thumb_title">
                                    <div class="tour_country"> <?=$p->popular_name?> </div>
                                    <a href="east-europe.html">
                                        <h3><?=$p->package_name?></h3>
                                    </a>
                                </div>
                                <div class="thumb_meta">
                                    <div class="tour_days"> <?=$p->days?> Days </div>
                                    <div class="tour_price"> Rs <?=$p->cost?> </div>
                                </div>
                                <br class="clear">
                                <div class="tour_excerpt"><?=$p->details?>
                                </div>
                            </div>
                        </div>
